...
/**
 * Used for injecting faults in DFSClient and DFSOutputStream tests. Calls into this are a no-op in
 * production code.
 */
@VisibleForTesting
...
public class DataNodeFaultInjector {
  ...
  public void logDelaySendingPacketDownstream(final String mirrAddr, final long delayMs)
      throws IOException {}
  ...
  public void logDelaySendingAckToUpstream(final String upstreamAddr, final long delayMs)
      throws IOException {}
