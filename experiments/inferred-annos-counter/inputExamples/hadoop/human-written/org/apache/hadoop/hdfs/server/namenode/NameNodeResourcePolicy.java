...
/**
 * Given a set of checkable resources, this class is capable of determining whether sufficient
 * resources are available for the NN to continue operating.
 */
@InterfaceAudience.Private
final class NameNodeResourcePolicy {

  /**
   * Return true if and only if there are sufficient NN resources to continue logging edits.
   *
   * @param resources the collection of resources to check.
   * @param minimumRedundantResources the minimum number of redundant resources required to continue
   *     operation.
   * @return true if and only if there are sufficient NN resources to continue logging edits.
   */
