...
/**
 * Information sent by a subordinate name-node to the active name-node during the registration
 * process.
 */
...
public class NamenodeRegistration extends StorageInfo implements NodeRegistration {
  ...
  public NamenodeRegistration(
      String address, String httpAddress, StorageInfo storageInfo, NamenodeRole role) {
    super(storageInfo);
