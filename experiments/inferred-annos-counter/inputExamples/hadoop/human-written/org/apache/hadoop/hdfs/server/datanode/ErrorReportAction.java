...
/**
 * A ErrorReportAction is an instruction issued by BPOfferService to BPServiceActor about a
 * particular block encapsulated in errorMessage.
 */
public class ErrorReportAction implements BPServiceActorAction {
  ...
  public void reportTo(
    ...
    try {
      ...
      DataNode.LOG.info(
          "trySendErrorReport encountered RemoteException  "
              + "errorMessage: "
              + errorMessage
              + "  errorCode: "
              + errorCode,
