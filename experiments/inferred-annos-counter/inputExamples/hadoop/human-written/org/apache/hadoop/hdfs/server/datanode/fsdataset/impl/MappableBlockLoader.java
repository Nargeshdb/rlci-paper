...
public abstract class MappableBlockLoader {
   ...
   * Load the block.
   *
   * <p>Map the block, and then verify its checksum.
   *
  ...
  abstract MappableBlock getRecoveredMappableBlock(File cacheFile, String bpid, byte volumeIndex)
      throws IOException;
  ...
  protected void verifyChecksum(
      long length, FileInputStream metaIn, FileChannel blockChannel, String blockFileName)
      throws IOException {
