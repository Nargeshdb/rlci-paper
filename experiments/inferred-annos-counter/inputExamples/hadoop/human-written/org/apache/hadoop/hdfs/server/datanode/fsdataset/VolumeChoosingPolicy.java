...
public interface VolumeChoosingPolicy<V extends FsVolumeSpi> {
  ...
  /**
   * Choose a volume to place a replica, given a list of volumes and the replica size sought for
   * storage.
   *
   * <p>The caller should synchronize access to the list of volumes.
   *
   * @param volumes - a list of available volumes.
   * @param replicaSize - the size of the replica for which a volume is sought.
   * @param storageId - the storage id of the Volume nominated by the namenode. This can usually be
   *     ignored by the VolumeChoosingPolicy.
