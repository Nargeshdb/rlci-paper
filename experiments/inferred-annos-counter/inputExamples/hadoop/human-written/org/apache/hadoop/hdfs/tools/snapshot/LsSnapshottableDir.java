...
/**
 * A tool used to list all snapshottable directories that are owned by the current user. The tool
 * returns all the snapshottable directories if the user is a super user.
 */
