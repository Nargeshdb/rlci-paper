 ...
 * DatanodeProtocol} interfaces to the RPC server implementing {@link DatanodeProtocolPB}.
 */
...
public class DatanodeProtocolClientSideTranslatorPB
  ...
  public DatanodeProtocolClientSideTranslatorPB(InetSocketAddress nameNodeAddr, Configuration conf)
      throws IOException {
  ...
  private static DatanodeProtocolPB createNamenode(
      InetSocketAddress nameNodeAddr, Configuration conf, UserGroupInformation ugi)
      throws IOException {
    return RPC.getProxy(
  ...
  public DatanodeCommand blockReport(
    ...
    for (StorageBlockReport r : reports) {
      StorageBlockReportProto.Builder reportBuilder =
          StorageBlockReportProto.newBuilder().setStorage(PBHelperClient.convert(r.getStorage()));
  ...
  public void blockReceivedAndDeleted(
    ...
    for (StorageReceivedDeletedBlocks storageBlock : receivedAndDeletedBlocks) {
      ...
      repBuilder.setStorageUuid(
          storageBlock.getStorage().getStorageID()); // Set for wire compatibility.
  ...
  public void commitBlockSynchronization(
    ...
    CommitBlockSynchronizationRequestProto.Builder builder =
        CommitBlockSynchronizationRequestProto.newBuilder()
            ...
            .setNewGenStamp(newgenerationstamp)
            .setNewLength(newlength)
            .setCloseFile(closeFile)
