...
/**
 * Fast and accurate class to tell how much space HDFS is using. This class gets hdfs used space
 * from FsDatasetImpl#volumeMap#ReplicaInfos that uses an in memory way.
 *
 * <p>Getting hdfs used space by ReplicaCachingGetSpaceUsed impl only includes block and meta files,
 * but DU impl is blockpool dir based statistics that will include additional files, e.g. tmp dir,
 * scanner.cursor file. Getting space used by DU impl will be greater than by
 * ReplicaCachingGetSpaceUsed impl, but the latter is more accurate.
 *
 * <p>Setting fs.getspaceused.classname to org.apache.hadoop.hdfs.server.datanode.fsdataset
