...
/**
 * StripedBlockReconstructor reconstruct one or more missed striped block in the striped block
 * group, the minimum number of live striped blocks should be no less than data block number.
 */
