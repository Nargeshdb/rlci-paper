...
/** Datanode statistics. For decommissioning/decommissioned nodes, only used capacity is counted. */
class DatanodeStats {
  ...
  static final class StorageTypeStatsMap {
    ...
    private void addNode(StorageType storageType, final DatanodeDescriptor node) {
    ...
    private void addStorage(final DatanodeStorageInfo info, final DatanodeDescriptor node) {
    ...
    private void subtractStorage(final DatanodeStorageInfo info, final DatanodeDescriptor node) {
      StorageTypeStats storageTypeStats = storageTypeStatsMap.get(info.getStorageType());
      if (storageTypeStats != null) {
    ...
    private void subtractNode(StorageType storageType, final DatanodeDescriptor node) {
      StorageTypeStats storageTypeStats = storageTypeStatsMap.get(storageType);
      if (storageTypeStats != null) {
