...
/**
 * BlockToMarkCorrupt is used to build the "toCorrupt" list, which is a list of blocks that should
 * be considered corrupt due to a block report.
 */
class BlockToMarkCorrupt {
  ...
  BlockToMarkCorrupt(
      Block corrupted, BlockInfo stored, String reason, CorruptReplicasMap.Reason reasonCode) {
