...
public interface SPSService {
   ...
   *
   * @param ctxt - context is an helper service to provide communication channel between NN and SPS
   */
  void init(Context ctxt);

  /**
   * Starts the SPS service. Make sure to initialize the helper services before invoking this
   * method.
   *
   ...
   *
   * @param forceStop true represents to clear all the sps path's hint, false otherwise.
   */
   ...
   *
   * @param itemInfo file info object for which need to satisfy the policy
   */
   ...
   *
   * @param startPathId - directoryId/fileId, on which SPS was called.
   * @param itemInfoList - list of item infos
   * @param scanCompleted - whether the scanning of directory fully done with itemInfoList
   */
   ...
   *
   * @param spsPath - satisfier path id
   */
   ...
   * @param block - block that is attempted to move
   */
