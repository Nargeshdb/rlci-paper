...
public abstract class FSLimitException extends QuotaExceededException {
  ...
  public static final class PathComponentTooLongException extends FSLimitException {
    ...
    public PathComponentTooLongException(
        long quota, long count, String parentPath, String childName) {
      super(quota, count);
    ...
    public String getMessage() {
      return "The maximum path component name limit of "
          + childName
          + " in directory "
          + getParentPath()
          + " is exceeded: limit="
  ...
  public static final class MaxDirectoryItemsExceededException extends FSLimitException {
    ...
    @Override
    public String getMessage() {
      return "The directory item limit of "
          + pathName
          + " is exceeded: limit="
          + quota
          + " items="
