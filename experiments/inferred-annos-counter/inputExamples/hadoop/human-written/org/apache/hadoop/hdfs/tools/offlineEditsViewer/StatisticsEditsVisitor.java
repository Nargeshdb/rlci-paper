...
/**
 * StatisticsEditsVisitor implements text version of EditsVisitor that aggregates counts of op codes
 * processed
 */
  ...
  public String getStatisticsString() {
    ...
    for (FSEditLogOpCodes opCode : FSEditLogOpCodes.values()) {
      ...
      sb.append(
          String.format(
              "    %-30.30s (%3d): %d%n",
              opCode.toString(), opCode.getOpCode(), count == null ? Long.valueOf(0L) : count));
    }
    return sb.toString();
  }
}
