...
/**
 * Generate the next valid block ID by incrementing the maximum block ID allocated so far, starting
 * at 2^30+1.
 *
 * <p>Block IDs used to be allocated randomly in the past. Hence we may find some conflicts while
 * stepping through the ID space sequentially. However given the sparsity of the ID space, conflicts
 * should be rare and can be skipped over when detected.
 */
  ...
  public long nextValue() {
    ...
    if (b.getBlockId() < 0) {
      throw new IllegalStateException(
          "All positive block IDs are used, "
