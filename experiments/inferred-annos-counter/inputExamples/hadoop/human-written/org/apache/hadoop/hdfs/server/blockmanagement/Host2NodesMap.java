...
class Host2NodesMap {
  ...
  /**
   * get a data node by its hostname. This should be used if only one datanode service is running on
   * a hostname. If multiple datanodes are running on a hostname then use methods
   * getDataNodeByXferAddr and getDataNodeByHostNameAndPort.
   *
