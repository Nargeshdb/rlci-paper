 ...
 * Hold the references count to a single instance. If there are no references then the entry will be
 * removed.<br>
...
public class ReferenceCountMap<E extends ReferenceCountMap.ReferenceCounter> {
  ...
  /**
   * Delete the reference. Decrease the reference count for the instance, if any. On all references
   * removal delete the instance from the map.
   *
