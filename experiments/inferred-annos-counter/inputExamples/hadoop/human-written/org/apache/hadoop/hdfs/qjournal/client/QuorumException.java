...
/** Exception thrown when too many exceptions occur while gathering responses to a quorum call. */
class QuorumException extends IOException {

  /**
   * Create a QuorumException instance with a descriptive message detailing the underlying
   * exceptions, as well as any successful responses which were returned.
   *
  ...
  public static <K, V> QuorumException create(
      String simpleMsg, Map<K, V> successes, Map<K, Throwable> exceptions) {
