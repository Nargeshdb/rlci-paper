...
/**
 * Dead simple session-layer HTTP proxy. It gets the HTTP responses inside the context, assuming
 * that the remote peer is reasonable fast and the response is small. The upper layer should be
 * filtering out malicious inputs.
 */
        ...
        new ChannelFutureListener() {
          ...
          public void operationComplete(ChannelFuture future) throws Exception {
            if (future.isSuccess()) {
              ...
              HttpRequest newReq =
                  new DefaultFullHttpRequest(HTTP_1_1, req.getMethod(), req.getUri());
