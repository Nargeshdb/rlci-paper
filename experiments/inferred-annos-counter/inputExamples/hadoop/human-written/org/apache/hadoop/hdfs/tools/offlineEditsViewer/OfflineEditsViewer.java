...
public class OfflineEditsViewer extends Configured implements Tool {
  ...
  public int go(
    ...
    if (xmlInput && StringUtils.equalsIgnoreCase("xml", processor)) {
      ...
      System.err.println(
          "Binary format input file is not allowed" + " to be processed by Binary processor.");
      return -1;
    }
    ...
    try {
      ...
      OfflineEditsLoader loader =
          OfflineEditsLoaderFactory.createLoader(visitor, inputFileName, xmlInput, flags);
      loader.loadEdits();
    } catch (Exception e) {
