...
/**
 * This class is the client side translator to translate the requests made on {@link
 * JournalProtocol} interfaces to the RPC server implementing {@link JournalProtocolPB}.
 */
...
public class QJournalProtocolTranslatorPB
    implements ProtocolMetaInterface, QJournalProtocol, Closeable {
  ...
  public boolean isFormatted(String journalId, String nameServiceId) throws IOException {
    try {
      IsFormattedRequestProto.Builder req =
          IsFormattedRequestProto.newBuilder().setJid(convertJournalId(journalId));
      if (nameServiceId != null) {
        req.setNameServiceId(nameServiceId);
      }

      IsFormattedResponseProto resp = rpcProxy.isFormatted(NULL_CONTROLLER, req.build());
  ...
  @Override
  public GetJournalStateResponseProto getJournalState(String jid, String nameServiceId)
      throws IOException {
    try {
      GetJournalStateRequestProto.Builder req =
          GetJournalStateRequestProto.newBuilder().setJid(convertJournalId(jid));
      if (nameServiceId != null) {
        req.setNameServiceId(nameServiceId);
      }
  ...
  @Override
  public void format(String jid, String nameServiceId, NamespaceInfo nsInfo, boolean force)
      throws IOException {
    try {
      FormatRequestProto.Builder req =
          FormatRequestProto.newBuilder()
  ...
  @Override
  public NewEpochResponseProto newEpoch(
      String jid, String nameServiceId, NamespaceInfo nsInfo, long epoch) throws IOException {
    try {
      NewEpochRequestProto.Builder req =
          NewEpochRequestProto.newBuilder()
              .setJid(convertJournalId(jid))
              .setNsInfo(PBHelper.convert(nsInfo))
              .setEpoch(epoch);
  ...
  public void journal(
      ...
      throws IOException {
    JournalRequestProto req =
        JournalRequestProto.newBuilder()
  ...
  public void heartbeat(RequestInfo reqInfo) throws IOException {
    try {
      rpcProxy.heartbeat(
          NULL_CONTROLLER, HeartbeatRequestProto.newBuilder().setReqInfo(convert(reqInfo)).build());
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  }
  ...
  private QJournalProtocolProtos.RequestInfoProto convert(RequestInfo reqInfo) {
    RequestInfoProto.Builder builder =
        RequestInfoProto.newBuilder()
  ...
  public void startLogSegment(RequestInfo reqInfo, long txid, int layoutVersion)
      throws IOException {
    StartLogSegmentRequestProto req =
        StartLogSegmentRequestProto.newBuilder()
            .setReqInfo(convert(reqInfo))
            .setTxid(txid)
  ...
  public void purgeLogsOlderThan(RequestInfo reqInfo, long minTxIdToKeep) throws IOException {
    PurgeLogsRequestProto req =
        PurgeLogsRequestProto.newBuilder()
            .setReqInfo(convert(reqInfo))
  ...
  public GetEditLogManifestResponseProto getEditLogManifest(
    ...
    try {
      ...
      return rpcProxy.getEditLogManifest(NULL_CONTROLLER, req.build());
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  }
  ...
  public PrepareRecoveryResponseProto prepareRecovery(RequestInfo reqInfo, long segmentTxId)
      throws IOException {
    try {
      return rpcProxy.prepareRecovery(
          NULL_CONTROLLER,
  ...
  public void doFinalize(String jid, String nameServiceId) throws IOException {
    try {
      DoFinalizeRequestProto.Builder req =
          DoFinalizeRequestProto.newBuilder().setJid(convertJournalId(jid));
      if (nameServiceId != null) {
        req.setNameServiceId(nameServiceId);
      }
  ...
  public Boolean canRollBack(
      ...
      throws IOException {
    try {
      CanRollBackRequestProto.Builder req =
      ...
      CanRollBackResponseProto response = rpcProxy.canRollBack(NULL_CONTROLLER, req.build());
  ...
  public void doRollback(String journalId, String nameServiceId) throws IOException {
    try {
      DoRollbackRequestProto.Builder req =
  ...
  public void discardSegments(String journalId, String nameServiceId, long startTxId)
      throws IOException {
    try {
      DiscardSegmentsRequestProto.Builder req =
  ...
  public Long getJournalCTime(String journalId, String nameServiceId) throws IOException {
    try {
      ...
      GetJournalCTimeRequestProto.Builder req =
          GetJournalCTimeRequestProto.newBuilder().setJid(convertJournalId(journalId));
      if (nameServiceId != null) {
        req.setNameServiceId(nameServiceId);
      }
      GetJournalCTimeResponseProto response =
          rpcProxy.getJournalCTime(NULL_CONTROLLER, req.build());
