...
public class XAttrStorage {
   ...
   * @return the xAttr
   */
  public static XAttr readINodeXAttrByPrefixedName(
   ...
   *
   * <p>Must be called while holding the FSDirectory read lock.
   *
   ...
   *
   * <p>Must be called while holding the FSDirectory write lock.
   *
   * @param inode INode to update
   * @param xAttrs to update xAttrs.
   * @param snapshotId id of the latest snapshot of the inode
   */
  public static void updateINodeXAttrs(INode inode, List<XAttr> xAttrs, int snapshotId)
