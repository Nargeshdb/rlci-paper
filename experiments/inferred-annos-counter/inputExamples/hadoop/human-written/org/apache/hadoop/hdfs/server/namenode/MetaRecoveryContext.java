...
public final class MetaRecoveryContext {
   ...
   * @param firstChoice First choice (will be taken if autoChooseDefault is true)
  ...
  public static void editLogLoaderPrompt(
      String prompt, MetaRecoveryContext recovery, String contStr)
