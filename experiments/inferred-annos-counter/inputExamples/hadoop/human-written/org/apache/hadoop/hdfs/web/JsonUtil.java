...
public class JsonUtil {
  ...
  private static Map<String, Object> toJsonMap(final Token<? extends TokenIdentifier> token)
      throws IOException {
    if (token == null) {
      return null;
    }
  ...
  public static Map<String, Object> getEcPolicyAsMap(final ErasureCodingPolicy ecPolicy) {
    /** Convert an ErasureCodingPolicy to a map. */
    ImmutableMap.Builder<String, Object> builder = ImmutableMap.builder();
    builder
        .put("name", ecPolicy.getName())
  ...
  private static Map<String, Object> toJson(final DirectoryListing listing) throws IOException {
  ...
  public static String toJsonString(final DirectoryListing listing) throws IOException {
  ...
  private static Object[] toJsonArray(final List<XAttr> array, final XAttrCodec encoding)
      throws IOException {
    if (array == null) {
      return null;
    } else if (array.size() == 0) {
  ...
  public static String toJsonString(SnapshotDiffReport diffReport) {
    return toJsonString(SnapshotDiffReport.class.getSimpleName(), toJsonMap(diffReport));
  }
  ...
  private static Object toJsonMap(SnapshotDiffReport.DiffReportEntry diffReportEntry) {
    ...
    if (diffReportEntry.getSourcePath() != null) {
      m.put("sourcePath", DFSUtilClient.bytes2String(diffReportEntry.getSourcePath()));
    }
    if (diffReportEntry.getTargetPath() != null) {
      m.put("targetPath", DFSUtilClient.bytes2String(diffReportEntry.getTargetPath()));
    }
    return m;
  }
  ...
  private static Object toJsonMap(SnapshottableDirectoryStatus snapshottableDirectoryStatus) {
    ...
    m.put(
        "parentFullPath",
        DFSUtilClient.bytes2String(snapshottableDirectoryStatus.getParentFullPath()));
    m.put("dirStatus", toJsonMap(snapshottableDirectoryStatus.getDirStatus()));
    return m;
  }

  private static Map<String, Object> toJsonMap(final BlockLocation blockLocation)
      throws IOException {
