...
/**
 * tool to get data from NameNode or DataNode using MBeans currently the following MBeans are
 * available (under hadoop domain): hadoop:service=NameNode,name=FSNamesystemState (static)
 ...
 *
 * <p>implementation note: all logging is sent to System.err (since it is a command line tool)
 */
...
public class JMXGet {
   ...
   */
  @SuppressWarnings(
      "builder:required.method.not.called") // TP: jmxc remains open in possible exceptional exit
                                            // due to jmxc.getMBeanServerConnection() (validated)
