...
class FSImageTransactionalStorageInspector extends FSImageStorageInspector {
  public static final Logger LOG =
      LoggerFactory.getLogger(FSImageTransactionalStorageInspector.class);
  ...
  /**
   * @return the image files that have the most recent associated transaction IDs. If there are
   *     multiple storage directories which contain equal images, we'll return them all.
