...
/**
 * This class provides an interface for Namenode and Router to Audit events information. This class
 * can be extended and can be used when no access logger is defined in the config file.
 */
