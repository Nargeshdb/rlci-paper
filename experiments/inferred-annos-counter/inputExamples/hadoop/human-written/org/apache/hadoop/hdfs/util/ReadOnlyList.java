...
/**
 * A {@link ReadOnlyList} is a unmodifiable list, which supports read-only operations.
 *
...
public interface ReadOnlyList<E> extends Iterable<E> {
  ...
  public static class Util {
    ...
    /**
     * The same as {@link Collections#binarySearch(List, Object)} except that the list is a {@link
     * ReadOnlyList}.
     *
     * @return the insertion point defined in {@link Collections#binarySearch(List, Object)}.
     */
    ...
    public static <E> List<E> asList(final ReadOnlyList<E> list) {
      return new List<E>() {
        ...
        @Override
        @SuppressWarnings(
            "mustcall:assignment") // FP Java 8 type argument inference:
