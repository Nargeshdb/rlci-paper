...
/**
 * Utilities for converting protobuf classes to and from implementation classes and other helper
 * utilities to help in dealing with protobuf.
 *
 * <p>Note that when converting from an internal type to protobuf type, the converter never return
 * null for protobuf type. The check for internal type being null must be done before calling the
 * convert() method.
 *
 * <p>For those helper methods that convert HDFS client-side data structures from and to protobuf,
 * see {@link PBHelperClient}.
 */
public class PBHelper {
  ...
  public static StorageInfoProto convert(StorageInfo info) {
    return StorageInfoProto.newBuilder()
  ...
  public static StorageInfo convert(StorageInfoProto info, NodeType type) {
    return new StorageInfo(
        info.getLayoutVersion(), info.getNamespceID(), info.getClusterID(), info.getCTime(), type);
  }
  ...
  public static NamenodeRegistrationProto convert(NamenodeRegistration reg) {
    return NamenodeRegistrationProto.newBuilder()
        ...
        .setStorageInfo(convert((StorageInfo) reg))
        .build();
  }
  ...
  public static NamenodeRegistration convert(NamenodeRegistrationProto reg) {
    ...
    return new NamenodeRegistration(
        reg.getRpcAddress(), reg.getHttpAddress(), si, convert(reg.getRole()));
  }

  public static BlockWithLocationsProto convert(BlockWithLocations blk) {
    BlockWithLocationsProto.Builder builder =
        BlockWithLocationsProto.newBuilder()
  ...
  public static BlockWithLocations convert(BlockWithLocationsProto b) {
    ...
    BlockWithLocations blk =
        new BlockWithLocations(
            PBHelperClient.convert(b.getBlock()),
    ...
    if (b.hasIndices()) {
      blk =
          new StripedBlockWithLocations(
              blk, b.getIndices().toByteArray(), (short) b.getDataBlockNum(), b.getCellSize());
    }
    return blk;
  }
  ...
  public static BlockKeyProto convert(BlockKey key) {
    ...
    ByteString keyBytes =
        PBHelperClient.getByteString(encodedKey == null ? DFSUtilClient.EMPTY_BYTES : encodedKey);
    return BlockKeyProto.newBuilder()
  ...
  public static ExportedBlockKeysProto convert(ExportedBlockKeys keys) {
    ...
    builder
        .setIsBlockTokenEnabled(keys.isBlockTokenEnabled())
  ...
  public static ExportedBlockKeys convert(ExportedBlockKeysProto keys) {
    return new ExportedBlockKeys(
        keys.getIsBlockTokenEnabled(),
        keys.getKeyUpdateInterval(),
        keys.getTokenLifeTime(),
  ...
  public static CheckpointSignatureProto convert(CheckpointSignature s) {
    return CheckpointSignatureProto.newBuilder()
        ...
        .setStorageInfo(PBHelper.convert((StorageInfo) s))
        .build();
  }
  ...
  public static CheckpointSignature convert(CheckpointSignatureProto s) {
    ...
    return new CheckpointSignature(
        si, s.getBlockPoolId(), s.getMostRecentCheckpointTxId(), s.getCurSegmentTxId());
  }
  ...
  public static RemoteEditLogProto convert(RemoteEditLog log) {
    return RemoteEditLogProto.newBuilder()
        ...
        .setIsInProgress(log.isInProgress())
        .build();
  }
  ...
  public static RemoteEditLogManifestProto convert(RemoteEditLogManifest manifest) {
    RemoteEditLogManifestProto.Builder builder =
        RemoteEditLogManifestProto.newBuilder().setCommittedTxnId(manifest.getCommittedTxnId());
  ...
  public static CheckpointCommandProto convert(CheckpointCommand cmd) {
    return CheckpointCommandProto.newBuilder()
        ...
        .setNeedToReturnImage(cmd.needToReturnImage())
        .build();
  }
  ...
  public static NamenodeCommandProto convert(NamenodeCommand cmd) {
    if (cmd instanceof CheckpointCommand) {
      return NamenodeCommandProto.newBuilder()
          ...
          .setCheckpointCmd(convert((CheckpointCommand) cmd))
          .build();
    }
    return NamenodeCommandProto.newBuilder()
    ...
    switch (cmd.getType()) {
      case CheckPointCommand:
        ...
        return new CheckpointCommand(
            PBHelper.convert(chkPt.getSignature()), chkPt.getNeedToReturnImage());
      default:
  ...
  public static RecoveringBlock convert(RecoveringBlockProto b) {
    ...
    if (b.hasTruncateBlock()) {
      rBlock =
          new RecoveringBlock(
              lb.getBlock(), lb.getLocations(), PBHelperClient.convert(b.getTruncateBlock()));
    } else {
    ...
    if (b.hasEcPolicy()) {
      ...
      rBlock =
          new RecoveringStripedBlock(
              rBlock, indices, PBHelperClient.convertErasureCodingPolicy(b.getEcPolicy()));
    }
    return rBlock;
  }
  ...
  public static DatanodeRegistrationProto convert(DatanodeRegistration registration) {
    ...
    return builder
        .setDatanodeID(PBHelperClient.convert((DatanodeID) registration))
        .setStorageInfo(convert(registration.getStorageInfo()))
        .setKeys(convert(registration.getExportedKeys()))
        .setSoftwareVersion(registration.getSoftwareVersion())
        .build();
  }
  ...
  public static DatanodeRegistration convert(DatanodeRegistrationProto proto) {
    ...
    return new DatanodeRegistration(
        ...
        si,
        convert(proto.getKeys()),
        proto.getSoftwareVersion());
  }
  ...
  public static BalancerBandwidthCommandProto convert(BalancerBandwidthCommand bbCmd) {
    return BalancerBandwidthCommandProto.newBuilder()
        .setBandwidth(bbCmd.getBalancerBandwidthValue())
        .build();
  }

  public static KeyUpdateCommandProto convert(KeyUpdateCommand cmd) {
    return KeyUpdateCommandProto.newBuilder().setKeys(convert(cmd.getExportedKeys())).build();
  }
  ...
  public static BlockCommandProto convert(BlockCommand cmd) {
    ...
    builder
        .addAllTargets(PBHelperClient.convert(cmd.getTargets()))
  ...
  public static BlockIdCommandProto convert(BlockIdCommand cmd) {
    BlockIdCommandProto.Builder builder =
        BlockIdCommandProto.newBuilder().setBlockPoolId(cmd.getBlockPoolId());
    switch (cmd.getAction()) {
  ...
  private static List<StorageUuidsProto> convert(String[][] targetStorageUuids) {
    ...
    for (int i = 0; i < targetStorageUuids.length; i++) {
      ret[i] =
          StorageUuidsProto.newBuilder()
              .addAllStorageUuids(Arrays.asList(targetStorageUuids[i]))
              .build();
    }
  ...
  public static DatanodeCommandProto convert(DatanodeCommand datanodeCommand) {
    ...
    switch (datanodeCommand.getAction()) {
      case DatanodeProtocol.DNA_BALANCERBANDWIDTHUPDATE:
        builder
            .setCmdType(DatanodeCommandProto.Type.BalancerBandwidthCommand)
            .setBalancerCmd(PBHelper.convert((BalancerBandwidthCommand) datanodeCommand));
        break;
      ...
      case DatanodeProtocol.DNA_RECOVERBLOCK:
        builder
            .setCmdType(DatanodeCommandProto.Type.BlockRecoveryCommand)
            .setRecoveryCmd(PBHelper.convert((BlockRecoveryCommand) datanodeCommand));
        break;
      case DatanodeProtocol.DNA_FINALIZE:
        builder
            .setCmdType(DatanodeCommandProto.Type.FinalizeCommand)
      ...
      case DatanodeProtocol.DNA_SHUTDOWN:
        builder
            .setCmdType(DatanodeCommandProto.Type.BlockCommand)
            .setBlkCmd(PBHelper.convert((BlockCommand) datanodeCommand));
        break;
      case DatanodeProtocol.DNA_CACHE:
      case DatanodeProtocol.DNA_UNCACHE:
        builder
            .setCmdType(DatanodeCommandProto.Type.BlockIdCommand)
            .setBlkIdCmd(PBHelper.convert((BlockIdCommand) datanodeCommand));
        break;
      case DatanodeProtocol.DNA_ERASURE_CODING_RECONSTRUCTION:
        builder
            .setCmdType(DatanodeCommandProto.Type.BlockECReconstructionCommand)
            .setBlkECReconstructionCmd(convert((BlockECReconstructionCommand) datanodeCommand));
        break;
  ...
  public static BlockCommand convert(BlockCommandProto blkCmd) {
    ...
    return new BlockCommand(
        action, blkCmd.getBlockPoolId(), blocks, targets, targetStorageTypes, targetStorageIDs);
  }
  ...
  public static VolumeFailureSummary convertVolumeFailureSummary(VolumeFailureSummaryProto proto) {
    ...
    return new VolumeFailureSummary(
        ...
        proto.getLastVolumeFailureDate(),
        proto.getEstimatedCapacityLostTotal());
  }
  ...
  public static List<SlowPeerReportProto> convertSlowPeerInfo(SlowPeerReports slowPeers) {
    if (slowPeers.getSlowPeers().size() == 0) {
      return Collections.emptyList();
    }

    List<SlowPeerReportProto> slowPeerInfoProtos = new ArrayList<>(slowPeers.getSlowPeers().size());
    for (Map.Entry<String, Double> entry : slowPeers.getSlowPeers().entrySet()) {
  ...
  public static SlowPeerReports convertSlowPeerInfo(List<SlowPeerReportProto> slowPeerProtos) {
    ...
    for (SlowPeerReportProto proto : slowPeerProtos) {
      ...
      slowPeersMap.put(
          proto.getDataNodeId(), proto.hasAggregateLatency() ? proto.getAggregateLatency() : 0.0);
    }
    return SlowPeerReports.create(slowPeersMap);
  }

  public static List<SlowDiskReportProto> convertSlowDiskInfo(SlowDiskReports slowDisks) {
    if (slowDisks.getSlowDisks().size() == 0) {
      return Collections.emptyList();
    }

    List<SlowDiskReportProto> slowDiskInfoProtos = new ArrayList<>(slowDisks.getSlowDisks().size());
    for (Map.Entry<String, Map<SlowDiskReports.DiskOp, Double>> entry :
      ...
      if (value.get(SlowDiskReports.DiskOp.METADATA) != null) {
        builder.setMeanMetadataOpLatency(value.get(SlowDiskReports.DiskOp.METADATA));
      }
      if (value.get(SlowDiskReports.DiskOp.READ) != null) {
        builder.setMeanReadIoLatency(value.get(SlowDiskReports.DiskOp.READ));
      }
      if (value.get(SlowDiskReports.DiskOp.WRITE) != null) {
        builder.setMeanWriteIoLatency(value.get(SlowDiskReports.DiskOp.WRITE));
      }
  ...
  public static SlowDiskReports convertSlowDiskInfo(List<SlowDiskReportProto> slowDiskProtos) {
  ...
  /**
   * Method used for converting {@link JournalInfoProto} sent from Namenode to Journal receivers to
   * {@link NamenodeRegistration}.
   */
  public static JournalInfoProto convert(JournalInfo j) {
    return JournalInfoProto.newBuilder()
        .setClusterID(j.getClusterId())
        .setLayoutVersion(j.getLayoutVersion())
        .setNamespaceID(j.getNamespaceId())
        .build();
  }

  public static BlockReportContext convert(BlockReportContextProto proto) {
    return new BlockReportContext(
        proto.getTotalRpcs(),
        proto.getCurRpc(),
        proto.getId(),
        proto.getLeaseId(),
  ...
  private static StorageTypesProto convertStorageTypesProto(StorageType[] targetStorageTypes) {
  ...
  private static String[] convert(HdfsProtos.StorageUuidsProto targetStorageUuidsProto) {
    List<String> storageUuidsList = targetStorageUuidsProto.getStorageUuidsList();
  ...
  public static BlockECReconstructionInfo convertBlockECReconstructionInfo(
    ...
    StorageTypesProto targetStorageTypesProto =
        blockEcReconstructionInfoProto.getTargetStorageTypes();
    StorageType[] convertStorageTypes =
        PBHelperClient.convertStorageTypes(
    ...
    ErasureCodingPolicy ecPolicy =
        PBHelperClient.convertErasureCodingPolicy(blockEcReconstructionInfoProto.getEcPolicy());
  ...
  public static BlockECReconstructionInfoProto convertBlockECRecoveryInfo(
    ...
    builder.setEcPolicy(
        PBHelperClient.convertErasureCodingPolicy(blockEcRecoveryInfo.getErasureCodingPolicy()));
  ...
  public static BlockECReconstructionCommand convert(
    ...
    return new BlockECReconstructionCommand(
        DatanodeProtocol.DNA_ERASURE_CODING_RECONSTRUCTION, blkECReconstructionInfos);
  }
  ...
  public static KeyValueProto convert(FileRegion fileRegion) {
    return KeyValueProto.newBuilder()
        ...
        .setValue(PBHelperClient.convert(fileRegion.getProvidedStorageLocation()))
        .build();
  }

  public static FileRegion convert(KeyValueProto keyValueProto) {
    BlockProto blockProto = keyValueProto.getKey();
    ProvidedStorageLocationProto providedStorageLocationProto = keyValueProto.getValue();
