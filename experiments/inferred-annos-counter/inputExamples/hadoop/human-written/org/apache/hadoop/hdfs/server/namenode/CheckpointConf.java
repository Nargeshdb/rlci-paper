  ...
  public CheckpointConf(Configuration conf) {
    ...
    checkpointPeriod =
        conf.getTimeDuration(
            ...
            TimeUnit.SECONDS);
    checkpointTxnCount =
        conf.getLong(DFS_NAMENODE_CHECKPOINT_TXNS_KEY, DFS_NAMENODE_CHECKPOINT_TXNS_DEFAULT);
    maxRetriesOnMergeError =
        conf.getInt(
            DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_KEY, DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_DEFAULT);
