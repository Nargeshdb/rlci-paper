...
/**
 * ReportBadBlockAction is an instruction issued by {{BPOfferService}} to {{BPServiceActor}} to
 * report bad block to namenode
 */
public class ReportBadBlockAction implements BPServiceActorAction {
  ...
  public void reportTo(
      DatanodeProtocolClientSideTranslatorPB bpNamenode, DatanodeRegistration bpRegistration)
    ...
    try {
      ...
      throw new BPServiceActorActionException(
          "Failed to report bad block " + block + " to namenode.", e);
    }
  }
