...
/**
 * This is the JMX management interface for NameNode status information. End users shouldn't be
...
public interface NameNodeStatusMXBean {
  ...
  /**
   * Retrieves information about slow DataNodes, if the feature is enabled. The report is in a JSON
   * format.
   */
