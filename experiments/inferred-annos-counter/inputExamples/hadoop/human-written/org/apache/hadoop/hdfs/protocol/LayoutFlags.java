...
/**
 * LayoutFlags represent features which the FSImage and edit logs can either support or not,
 * independently of layout version.
 *
 * <p>Note: all flags starting with 'test' are reserved for unit test purposes.
 */
  ...
  public static LayoutFlags read(DataInputStream in) throws IOException {
    ...
    if (length < 0) {
      throw new IOException(
          "The length of the feature flag section " + "was negative at " + length + " bytes.");
    } else if (length > 0) {
      throw new IOException(
