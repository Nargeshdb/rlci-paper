...
public interface DatanodeStatistics {
  ...
  /**
   * @return the total used space by data nodes for non-DFS purposes such as storing temporary files
   *     on the local file system
   */
  public long getCapacityUsedNonDFS();

  /** The same as {@link ClientProtocol#getStats()}. The block related entries are set to -1. */
