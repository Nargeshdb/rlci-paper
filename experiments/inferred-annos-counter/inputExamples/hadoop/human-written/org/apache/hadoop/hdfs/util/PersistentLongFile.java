...
/**
 * Class that represents a file on disk which persistently stores a single <code>long</code> value.
 * The file is updated atomically and durably (i.e fsynced).
 */
@InterfaceAudience.Private
public class PersistentLongFile {
  private static final Logger LOG = LoggerFactory.getLogger(PersistentLongFile.class);
  ...
  @SuppressWarnings(
      "builder:required.method.not.called") // FP
                                            ...
                                            // for some reason we couldn't verify that
                                            // cleanupWithLogger closes br (validated)
