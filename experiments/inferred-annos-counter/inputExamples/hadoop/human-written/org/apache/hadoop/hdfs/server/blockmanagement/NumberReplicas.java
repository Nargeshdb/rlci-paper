...
/**
 * A immutable object that stores the number of live replicas and the number of decommissioned
 * Replicas.
 */
public class NumberReplicas extends EnumCounters<NumberReplicas.StoredReplicaState> {
  ...
  /**
   * @return the number of replicas which are on stale nodes. This is not mutually exclusive with
   *     the other counts -- ie a replica may count as both "live" and "stale".
   */
