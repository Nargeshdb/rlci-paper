...
class ExcessRedundancyMap {
  ...
  /**
   * @return does this map contains a redundancy corresponding to the given datanode and the given
   *     block?
   */
  ...
  /**
   * Add the redundancy of the given block stored in the given datanode to the map.
   *
  ...
  /**
   * Remove the redundancy corresponding to the given datanode and the given block.
   *
