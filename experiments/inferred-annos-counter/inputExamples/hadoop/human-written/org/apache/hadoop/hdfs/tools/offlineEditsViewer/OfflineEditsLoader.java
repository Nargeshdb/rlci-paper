...
@InheritableMustCall("loadEdits")
interface OfflineEditsLoader {

  public abstract void loadEdits() throws IOException;

  static class OfflineEditsLoaderFactory {
    static OfflineEditsLoader createLoader(
        ...
        try {
          ...
          elis =
              new EditLogFileInputStream(
                  file, HdfsServerConstants.INVALID_TXID, HdfsServerConstants.INVALID_TXID, false);
