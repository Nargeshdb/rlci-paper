...
/**
 * A tool used to get the difference report between two snapshots, or between a snapshot and the
 * current status of a directory.
 *
 * <pre>
  ...
  public int run(String[] argv) throws Exception {
    ...
    try {
      SnapshotDiffReport diffReport =
          dfs.getSnapshotDiffReport(snapshotRoot, fromSnapshot, toSnapshot);
