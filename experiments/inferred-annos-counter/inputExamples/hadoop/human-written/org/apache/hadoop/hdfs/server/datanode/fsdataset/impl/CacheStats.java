...
class CacheStats {
   ...
   *
   * <p>This number is an overestimate, counting bytes that will be used only if pending caching
   * operations succeed. It does not take into account pending uncaching operations.
   *
   * <p>This overestimate is more useful to the NameNode than an underestimate, since we don't want
   * the NameNode to assign us more replicas than we can cache, because of the current batch of
   * operations.
   */
