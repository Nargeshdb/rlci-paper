...
public interface PeerServer extends Closeable {
  ...
  /**
   * Listens for a connection to be made to this server and accepts it. The method blocks until a
   * connection is made.
   *
   * @exception IOException if an I/O error occurs when waiting for a connection.
   * @exception SecurityException if a security manager exists and its <code>checkAccept</code>
   *     method doesn't allow the operation.
   * @exception SocketTimeoutException if a timeout was previously set and the timeout has been
   *     reached.
   */
