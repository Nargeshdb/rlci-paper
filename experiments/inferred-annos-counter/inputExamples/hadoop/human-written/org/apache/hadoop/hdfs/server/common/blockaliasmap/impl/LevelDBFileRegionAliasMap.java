...
public class LevelDBFileRegionAliasMap extends BlockAliasMap<FileRegion> implements Configurable {
  ...
  public Reader<FileRegion> getReader(Reader.Options opts, String blockPoolID) throws IOException {
    ...
    return new LevelDBFileRegionAliasMap.LevelDBReader(createDB(o.levelDBPath, false, blockPoolID));
  }
  ...
  public Writer<FileRegion> getWriter(Writer.Options opts, String blockPoolID) throws IOException {
    ...
    LevelDBOptions o = (LevelDBOptions) opts;
    return new LevelDBFileRegionAliasMap.LevelDBWriter(createDB(o.levelDBPath, true, blockPoolID));
  }

  private static DB createDB(String levelDBPath, boolean createIfMissing, String blockPoolID)
      throws IOException {
  ...
  public static class LevelDBOptions
      implements LevelDBReader.Options, LevelDBWriter.Options, Configurable {
    private Configuration conf;
    ...
    static class FRIterator implements Iterator<FileRegion> {
      ...
      public FileRegion next() {
        ...
        try {
          ...
          ProvidedStorageLocation psl = fromProvidedStorageLocationBytes(entry.getValue());
