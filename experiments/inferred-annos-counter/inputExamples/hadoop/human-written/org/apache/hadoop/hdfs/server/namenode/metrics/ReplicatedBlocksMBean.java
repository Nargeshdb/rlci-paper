...
/**
 * This interface defines the methods to get status pertaining to blocks of type {@link
 * org.apache.hadoop.hdfs.protocol.BlockType#CONTIGUOUS} in FSNamesystem of a NameNode. It is also
 * used for publishing via JMX.
 *
 * <p>Aggregated status of all blocks is reported in
 *
 * @see FSNamesystemMBean Name Node runtime activity statistic info is reported in
