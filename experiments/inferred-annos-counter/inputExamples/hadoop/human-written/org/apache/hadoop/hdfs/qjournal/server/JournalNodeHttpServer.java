...
public class JournalNodeHttpServer {
  ...
  void start() throws IOException {
    ...
    if (httpsAddr != null) {
      ...
      final String bindHost = conf.getTrimmed(DFSConfigKeys.DFS_JOURNALNODE_HTTPS_BIND_HOST_KEY);
    ...
    if (policy.isHttpEnabled()) {
      ...
      conf.set(
          DFSConfigKeys.DFS_JOURNALNODE_HTTP_ADDRESS_KEY, NetUtils.getHostPortString(httpAddress));
    }
