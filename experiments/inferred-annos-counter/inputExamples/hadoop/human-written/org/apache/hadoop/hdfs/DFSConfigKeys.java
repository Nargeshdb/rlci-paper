...
public class DFSConfigKeys extends CommonConfigurationKeys {
  public static final String DFS_BLOCK_SIZE_KEY = HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY;
  public static final long DFS_BLOCK_SIZE_DEFAULT = HdfsClientConfigKeys.DFS_BLOCK_SIZE_DEFAULT;
  ...
  public static final String DFS_CHECKSUM_TYPE_KEY = HdfsClientConfigKeys.DFS_CHECKSUM_TYPE_KEY;
  ...
  public static final long DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_DEFAULT = 100 * 1024 * 1024;
  public static final String DFS_DATANODE_BALANCE_MAX_NUM_CONCURRENT_MOVES_KEY =
      "dfs.datanode.balance.max.concurrent.moves";
  public static final int DFS_DATANODE_BALANCE_MAX_NUM_CONCURRENT_MOVES_DEFAULT = 100;
  ...
  public static final String DFS_DATANODE_SYNC_BEHIND_WRITES_IN_BACKGROUND_KEY =
  ...
  public static final String DFS_DATANODE_FSDATASETCACHE_MAX_THREADS_PER_VOLUME_KEY =
  ...
  public static final Class<RamDiskReplicaLruTracker>
      DFS_DATANODE_RAM_DISK_REPLICA_TRACKER_DEFAULT = RamDiskReplicaLruTracker.class;
  ...
  public static final String DFS_DATANODE_FIXED_VOLUME_SIZE_KEY = "dfs.datanode.fixed.volume.size";
  ...
  public static final long DFS_DATANODE_REPLICA_CACHE_EXPIRY_TIME_DEFAULT = 300000;
  ...
  public static final String DFS_NAMENODE_CHECKPOINT_QUIET_MULTIPLIER_KEY =
  ...
  public static final String DFS_NAMENODE_MISSING_CHECKPOINT_PERIODS_BEFORE_SHUTDOWN_KEY =
  ...
  public static final boolean DFS_NAMENODE_REDUNDANCY_CONSIDERLOAD_DEFAULT = true;
  public static final String DFS_NAMENODE_READ_CONSIDERLOAD_KEY = "dfs.namenode.read.considerLoad";
  public static final boolean DFS_NAMENODE_READ_CONSIDERLOAD_DEFAULT = false;
  public static final String DFS_NAMENODE_REDUNDANCY_CONSIDERLOAD_FACTOR =
      "dfs.namenode.redundancy.considerLoad.factor";
  public static final double DFS_NAMENODE_REDUNDANCY_CONSIDERLOAD_FACTOR_DEFAULT = 2.0;
  ...
  public static final int DFS_NAMENODE_REDUNDANCY_QUEUE_RESTART_ITERATIONS_DEFAULT = 2400;
  ...
  public static final int DFS_NAMENODE_RECONSTRUCTION_PENDING_TIMEOUT_SEC_DEFAULT = 300;

  public static final String DFS_NAMENODE_MAINTENANCE_REPLICATION_MIN_KEY =
      "dfs.namenode.maintenance.replication.min";
  public static final int DFS_NAMENODE_MAINTENANCE_REPLICATION_MIN_DEFAULT = 1;

  public static final String DFS_NAMENODE_MAX_CORRUPT_FILE_BLOCKS_RETURNED_KEY =
  ...
  public static final int DFS_NAMENODE_STORAGEINFO_DEFRAGMENT_INTERVAL_MS_DEFAULT = 10 * 60 * 1000;
  ...
  public static final double DFS_NAMENODE_STORAGEINFO_DEFRAGMENT_RATIO_DEFAULT = 0.75;
  public static final String DFS_NAMENODE_BLOCKREPORT_QUEUE_SIZE_KEY =
      "dfs.namenode.blockreport.queue.size";
  public static final int DFS_NAMENODE_BLOCKREPORT_QUEUE_SIZE_DEFAULT = 1024;
  public static final String DFS_NAMENODE_BLOCKREPORT_MAX_LOCK_HOLD_TIME =
      "dfs.namenode.blockreport.max.lock.hold.time";
  public static final long DFS_NAMENODE_BLOCKREPORT_MAX_LOCK_HOLD_TIME_DEFAULT = 4;

  public static final String DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED =
      "dfs.namenode.corrupt.block.delete.immediately.enabled";
  public static final boolean DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED_DEFAULT = true;
  ...
  public static final boolean DFS_PERMISSIONS_CONTENT_SUMMARY_SUBACCESS_DEFAULT = false;
  ...
  public static final boolean DFS_PERMISSIONS_ALLOW_OWNER_SET_QUOTA_DEFAULT = false;
  ...
  public static final boolean DFS_NAMENODE_POSIX_ACL_INHERITANCE_ENABLED_DEFAULT = true;
  ...
  public static final String DFS_NAMENODE_NUM_CHECKPOINTS_RETAINED_KEY =
      "dfs.namenode.num.checkpoints.retained";
  public static final int DFS_NAMENODE_NUM_CHECKPOINTS_RETAINED_DEFAULT = 2;
  public static final String DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY =
      "dfs.namenode.num.extra.edits.retained";
  public static final int DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_DEFAULT = 1000000; // 1M
  public static final String DFS_NAMENODE_MAX_EXTRA_EDITS_SEGMENTS_RETAINED_KEY =
  ...
  public static final String DFS_NAMENODE_EDIT_LOG_AUTOROLL_MULTIPLIER_THRESHOLD =
      "dfs.namenode.edit.log.autoroll.multiplier.threshold";
  public static final float DFS_NAMENODE_EDIT_LOG_AUTOROLL_MULTIPLIER_THRESHOLD_DEFAULT = 0.5f;
  ...
  public static final String DFS_NAMENODE_LAZY_PERSIST_FILE_SCRUB_INTERVAL_SEC =
  ...
  public static final String DFS_DATANODE_VOLUMES_REPLICA_ADD_THREADPOOL_SIZE_KEY =
  ...
  public static final String DFS_DATANODE_OOB_TIMEOUT_DEFAULT =
      "1500,0,0,0"; // OOB_TYPE1, OOB_TYPE2, OOB_TYPE3, OOB_TYPE4

  public static final String DFS_DATANODE_CACHE_REVOCATION_TIMEOUT_MS =
  ...
  public static final String DFS_DATANODE_PMEM_CACHE_DIRS_KEY = "dfs.datanode.pmem.cache.dirs";
  ...
  public static final boolean DFS_DATANODE_PMEM_CACHE_RECOVERY_DEFAULT = true;
  ...
  public static final String DFS_NAMENODE_DATANODE_REGISTRATION_IP_HOSTNAME_CHECK_KEY =
  ...
  public static final String DFS_NAMENODE_STARTUP_DELAY_BLOCK_DELETION_SEC_KEY =
  ...
  public static final String DFS_NAMENODE_SNAPSHOT_SKIP_CAPTURE_ACCESSTIME_ONLY_CHANGE =
      "dfs.namenode.snapshot.skip.capture.accesstime-only-change";
  public static final boolean DFS_NAMENODE_SNAPSHOT_SKIP_CAPTURE_ACCESSTIME_ONLY_CHANGE_DEFAULT =
      false;

  public static final String DFS_NAMENODE_SNAPSHOT_DIFF_ALLOW_SNAP_ROOT_DESCENDANT =
      "dfs.namenode.snapshotdiff.allow.snap-root-descendant";
  public static final boolean DFS_NAMENODE_SNAPSHOT_DIFF_ALLOW_SNAP_ROOT_DESCENDANT_DEFAULT = true;

  public static final String DFS_NAMENODE_SNAPSHOT_DIFF_LISTING_LIMIT =
      "dfs.namenode.snapshotdiff.listing.limit";
  public static final int DFS_NAMENODE_SNAPSHOT_DIFF_LISTING_LIMIT_DEFAULT = 1000;

  public static final String DFS_NAMENODE_SNAPSHOT_MAX_LIMIT = "dfs.namenode.snapshot.max.limit";
  ...
  public static final int DFS_NAMENODE_SNAPSHOT_SKIPLIST_SKIP_INTERVAL_DEFAULT = 10;
  public static final String DFS_NAMENODE_SNAPSHOT_SKIPLIST_MAX_LEVELS =
      "dfs.namenode.snapshot.skiplist.max.levels";
  public static final int DFS_NAMENODE_SNAPSHOT_SKIPLIST_MAX_SKIP_LEVELS_DEFAULT = 0;
  ...
  public static final boolean DFS_NAMENODE_ENABLE_LOG_STALE_DATANODE_DEFAULT = false;
  ...
  // The stale interval cannot be too small since otherwise this may cause too frequent churn on
  // stale states.
  ...
  public static final String DFS_NAMENODE_USE_STALE_DATANODE_FOR_WRITE_RATIO_KEY =
  ...
  public static final String DFS_NAMENODE_BLOCKS_PER_POSTPONEDBLOCKS_RESCAN_KEY =
  ...
  public static final long DFS_NAMENODE_DELEGATION_TOKEN_RENEW_INTERVAL_DEFAULT =
      24 * 60 * 60 * 1000; // 1 day
  ...
  public static final String DFS_NAMENODE_MAX_LOCK_HOLD_TO_RELEASE_LEASE_MS_KEY =
  ...
  public static final String DFS_NAMENODE_FSLOCK_FAIR_KEY = "dfs.namenode.fslock.fair";
  ...
  public static final boolean DFS_NAMENODE_LOCK_DETAILED_METRICS_DEFAULT = false;
  ...
  public static final long DFS_LOCK_SUPPRESS_WARNING_INTERVAL_DEFAULT = 10000; // ms
  ...
  public static final long DFS_DATANODE_LOCK_REPORTING_THRESHOLD_MS_DEFAULT = 300L;
  ...
  public static final String DFS_NAMENODE_NAME_DIR_PERMISSION_KEY = "dfs.namenode.storage.dir.perm";
  public static final String DFS_NAMENODE_NAME_DIR_PERMISSION_DEFAULT = "700";
  ...
  public static final String DFS_DATANODE_PEER_METRICS_MIN_OUTLIER_DETECTION_SAMPLES_KEY =
      "dfs.datanode.peer.metrics.min.outlier.detection.samples";
  public static final long DFS_DATANODE_PEER_METRICS_MIN_OUTLIER_DETECTION_SAMPLES_DEFAULT = 1000;
  ...
  /**
   * The maximum number of getBlocks RPCs data movement utilities can make to a NameNode per second.
   * Values <= 0 disable throttling. This affects anything that uses a NameNodeConnector, i.e., the
   * Balancer, Mover, and StoragePolicySatisfier.
   */
  ...
  public static final long DFS_BALANCER_GETBLOCKS_MIN_BLOCK_SIZE_DEFAULT =
      10L * 1024 * 1024; // 10MB
  ...
  public static final long DFS_BALANCER_SERVICE_INTERVAL_DEFAULT =
      TimeUnit.MINUTES.toMillis(5); // 5 mins
  public static final String DFS_BALANCER_SERVICE_RETRIES_ON_EXCEPTION =
  ...
  public static final int DFS_STORAGE_POLICY_SATISFIER_QUEUE_LIMIT_DEFAULT = 1000;
  ...
  public static final int DFS_SPS_WORK_MULTIPLIER_PER_ITERATION_DEFAULT = 1;
  ...
  public static final int DFS_STORAGE_POLICY_SATISFIER_MAX_RETRY_ATTEMPTS_DEFAULT = 3;
  ...
  public static final long DFS_SPS_DATANODE_CACHE_REFRESH_INTERVAL_MS_DEFAULT = 300000L;

  // SPS keytab configurations, by default it is disabled.
  public static final String DFS_SPS_ADDRESS_KEY = "dfs.storage.policy.satisfier.address";
  public static final String DFS_SPS_ADDRESS_DEFAULT = "0.0.0.0:0";
  public static final String DFS_SPS_KEYTAB_FILE_KEY = "dfs.storage.policy.satisfier.keytab.file";
  ...
  public static final boolean DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY_DEFAULT = true;
  public static final String DFS_NAMENODE_EC_SYSTEM_DEFAULT_POLICY =
      "dfs.namenode.ec.system.default.policy";
  public static final String DFS_NAMENODE_EC_SYSTEM_DEFAULT_POLICY_DEFAULT = "RS-6-3-1024k";
  ...
  public static final String DFS_DN_EC_RECONSTRUCTION_STRIPED_READ_TIMEOUT_MILLIS_KEY =
  ...
  public static final float DFS_DN_EC_RECONSTRUCTION_XMITS_WEIGHT_DEFAULT = 0.5f;

  public static final String DFS_DATANODE_DIRECTORYSCAN_THROTTLE_LIMIT_MS_PER_SEC_KEY =
      "dfs.datanode.directoryscan.throttle.limit.ms.per.sec";
  public static final int DFS_DATANODE_DIRECTORYSCAN_THROTTLE_LIMIT_MS_PER_SEC_DEFAULT = -1;
  ...
  public static final String DFS_NAMENODE_PATH_BASED_CACHE_RETRY_INTERVAL_MS =
  ...
  public static final String DFS_NAMENODE_DECOMMISSION_MAX_CONCURRENT_TRACKED_NODES =
  ...
  public static final String DFS_NAMENODE_DECOMMISSION_MONITOR_CLASS_DEFAULT =
      "org.apache.hadoop.hdfs.server.blockmanagement." + "DatanodeAdminDefaultMonitor";
  public static final String DFS_NAMENODE_DECOMMISSION_BACKOFF_MONITOR_PENDING_LIMIT =
      "dfs.namenode.decommission.backoff.monitor.pending.limit";
  public static final int DFS_NAMENODE_DECOMMISSION_BACKOFF_MONITOR_PENDING_LIMIT_DEFAULT = 10000;
  ...
  public static final int
      DFS_NAMENODE_DECOMMISSION_BACKOFF_MONITOR_PENDING_BLOCKS_PER_LOCK_DEFAULT = 1000;
  ...
  public static final String DFS_DATANODE_HTTPSERVER_FILTER_HANDLERS =
      "dfs.datanode.httpserver.filter.handlers";
  public static final String DFS_DATANODE_HTTPSERVER_FILTER_HANDLERS_DEFAULT =
  ...
  public static final String DFS_NAMENODE_INODE_ATTRIBUTES_PROVIDER_BYPASS_USERS_KEY =
  ...
  public static final String DFS_BLOCK_ACCESS_TOKEN_PROTOBUF_ENABLE =
  ...
  public static final Class<BlockPlacementPolicyRackFaultTolerant>
      DFS_BLOCK_PLACEMENT_EC_CLASSNAME_DEFAULT = BlockPlacementPolicyRackFaultTolerant.class;
  ...
  public static final long DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS_DEFAULT =
      5L * 60L * 1000L;
  ...
  public static final String DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_DEFAULT = "30m";
  ...
  public static final long DFS_IMAGE_TRANSFER_BOOTSTRAP_STANDBY_RATE_DEFAULT = 0; // no throttling
  ...
  public static final String DFS_IMAGE_PARALLEL_LOAD_KEY = "dfs.image.parallel.load";
  ...
  public static final String DFS_IMAGE_PARALLEL_THREADS_KEY = "dfs.image.parallel.threads";
  public static final int DFS_IMAGE_PARALLEL_THREADS_DEFAULT = 4;

  // Edit Log segment transfer timeout
  public static final String DFS_EDIT_LOG_TRANSFER_TIMEOUT_KEY = "dfs.edit.log.transfer.timeout";
  ...
  public static final String DFS_QJM_OPERATIONS_TIMEOUT = "dfs.qjm.operations.timeout";
  ...
  public static final boolean DFS_DATANODE_ENABLE_FILEIO_FAULT_INJECTION_DEFAULT = false;
  public static final String DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY =
      "dfs.datanode.fileio.profiling.sampling.percentage";
  public static final int DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_DEFAULT = 0;
  ...
  public static final String DFS_SHORT_CIRCUIT_SHARED_MEMORY_WATCHER_INTERRUPT_CHECK_MS =
  ...
  public static final int DFS_SHORT_CIRCUIT_SHARED_MEMORY_WATCHER_INTERRUPT_CHECK_MS_DEFAULT =
      HdfsClientConfigKeys.DFS_SHORT_CIRCUIT_SHARED_MEMORY_WATCHER_INTERRUPT_CHECK_MS_DEFAULT;
  ...
  public static final String DFS_SECONDARY_NAMENODE_KERBEROS_INTERNAL_SPNEGO_PRINCIPAL_KEY =
      "dfs.secondary.namenode.kerberos.internal.spnego.principal";

  @Deprecated
  public static final String DFS_SECONDARY_NAMENODE_INTERNAL_SPNEGO_USER_NAME_KEY =
  ...
  public static final String DFS_WEB_AUTHENTICATION_SIMPLE_ANONYMOUS_ALLOWED =
  ...
  public static final boolean
      DFS_NAMENODE_AVAILABLE_SPACE_BLOCK_PLACEMENT_POLICY_BALANCE_LOCAL_NODE_DEFAULT = false;
  ...
  public static final boolean DFS_NAMENODE_GC_TIME_MONITOR_ENABLE_DEFAULT = true;
  public static final String DFS_NAMENODE_GC_TIME_MONITOR_OBSERVATION_WINDOW_MS =
      "dfs.namenode.gc.time.monitor.observation.window.ms";
  public static final long DFS_NAMENODE_GC_TIME_MONITOR_OBSERVATION_WINDOW_MS_DEFAULT =
  ...
  public static final long DFS_NAMENODE_GC_TIME_MONITOR_SLEEP_INTERVAL_MS_DEFAULT =
  ...
  public static final boolean DFS_STORAGE_POLICY_PERMISSIONS_SUPERUSER_ONLY_DEFAULT = false;
  ...
  public static final boolean DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE_DEFAULT = false;
  ...
  public static final boolean DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_DERIVED_QOP_DEFAULT = false;
  ...
  public static final String DFS_NAMENODE_LIST_REENCRYPTION_STATUS_NUM_RESPONSES_KEY =
  ...
  public static final int DFS_NAMENODE_LIST_OPENFILES_NUM_RESPONSES_DEFAULT = 1000;
  public static final String DFS_NAMENODE_EDEKCACHELOADER_INTERVAL_MS_KEY =
      "dfs.namenode.edekcacheloader.interval.ms";
  public static final int DFS_NAMENODE_EDEKCACHELOADER_INTERVAL_MS_DEFAULT = 1000;
  public static final String DFS_NAMENODE_EDEKCACHELOADER_INITIAL_DELAY_MS_KEY =
  ...
  public static final String DFS_NAMENODE_REENCRYPT_THROTTLE_LIMIT_UPDATER_RATIO_KEY =
  ...
  public static final String DFS_NAMENODE_REENCRYPT_EDEK_THREADS_KEY =
  ...
  public static final String DFS_JOURNALNODE_RPC_ADDRESS_DEFAULT =
      "0.0.0.0:" + DFS_JOURNALNODE_RPC_PORT_DEFAULT;
  public static final String DFS_JOURNAL_EDITS_DIR_PERMISSION_KEY =
      "dfs.journalnode.edits.dir.perm";
  public static final String DFS_JOURNAL_EDITS_DIR_PERMISSION_DEFAULT = "700";
  ...
  public static final String DFS_JOURNALNODE_HTTPS_BIND_HOST_KEY =
      "dfs.journalnode.https-bind-host";
  public static final String DFS_JOURNALNODE_HTTPS_ADDRESS_DEFAULT =
      "0.0.0.0:" + DFS_JOURNALNODE_HTTPS_PORT_DEFAULT;
  ...
  public static final String DFS_JOURNALNODE_KERBEROS_INTERNAL_SPNEGO_PRINCIPAL_KEY =
      "dfs.journalnode.kerberos.internal.spnego.principal";
  public static final String DFS_JOURNALNODE_ENABLE_SYNC_KEY = "dfs.journalnode.enable.sync";
  public static final boolean DFS_JOURNALNODE_ENABLE_SYNC_DEFAULT = true;
  public static final String DFS_JOURNALNODE_SYNC_INTERVAL_KEY = "dfs.journalnode.sync.interval";
  ...
  public static final String DFS_QJOURNAL_PREPARE_RECOVERY_TIMEOUT_KEY =
      "dfs.qjournal.prepare-recovery.timeout.ms";
  public static final String DFS_QJOURNAL_ACCEPT_RECOVERY_TIMEOUT_KEY =
      "dfs.qjournal.accept-recovery.timeout.ms";
  public static final String DFS_QJOURNAL_FINALIZE_SEGMENT_TIMEOUT_KEY =
      "dfs.qjournal.finalize-segment.timeout.ms";
  public static final String DFS_QJOURNAL_SELECT_INPUT_STREAMS_TIMEOUT_KEY =
  ...
  public static final String DFS_DATANODE_TRANSFER_SOCKET_SEND_BUFFER_SIZE_KEY =
      "dfs.datanode.transfer.socket.send.buffer.size";
  public static final int DFS_DATANODE_TRANSFER_SOCKET_SEND_BUFFER_SIZE_DEFAULT =
      HdfsConstants.DEFAULT_DATA_SOCKET_SIZE;

  public static final String DFS_DATANODE_TRANSFER_SOCKET_RECV_BUFFER_SIZE_KEY =
      "dfs.datanode.transfer.socket.recv.buffer.size";
  public static final int DFS_DATANODE_TRANSFER_SOCKET_RECV_BUFFER_SIZE_DEFAULT =
      HdfsConstants.DEFAULT_DATA_SOCKET_SIZE;

  public static final String DFS_DATA_TRANSFER_SERVER_TCPNODELAY =
  ...
  public static final String DFS_DISK_BALANCER_PLAN_VALID_INTERVAL_DEFAULT = "1d";
  ...
  public static final String HTTPFS_BUFFER_SIZE_KEY = "httpfs.buffer.size";
  public static final int HTTP_BUFFER_SIZE_DEFAULT = 4096;

  public static final String DFS_USE_DFS_NETWORK_TOPOLOGY_KEY = "dfs.use.dfs.network.topology";
  public static final boolean DFS_USE_DFS_NETWORK_TOPOLOGY_DEFAULT = true;

  public static final String DFS_NET_TOPOLOGY_IMPL_KEY = "dfs.net.topology.impl";
  ...
  public static final String DFS_NAMENODE_SEND_QOP_ENABLED = "dfs.namenode.send.qop.enabled";
  ...
  @Deprecated
  public static final String DFS_CLIENT_MMAP_ENABLED = HdfsClientConfigKeys.Mmap.ENABLED_KEY;
  ...
  @Deprecated
  public static final String DFS_CLIENT_MMAP_CACHE_SIZE = HdfsClientConfigKeys.Mmap.CACHE_SIZE_KEY;
  ...
  @Deprecated
  public static final String DFS_CLIENT_CONTEXT = HdfsClientConfigKeys.DFS_CLIENT_CONTEXT;
  ...
  // the initial delay (unit is ms) for locateFollowingBlock, the delay time will increase
  // exponentially(double) for each retry.
  @Deprecated
  ...
  public static final String DFS_LEASE_HARDLIMIT_KEY = HdfsClientConfigKeys.DFS_LEASE_HARDLIMIT_KEY;
