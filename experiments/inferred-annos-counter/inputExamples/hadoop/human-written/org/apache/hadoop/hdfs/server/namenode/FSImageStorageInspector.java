...
/**
 * Interface responsible for inspecting a set of storage directories and devising a plan to load the
 * namespace from them.
 */
...
abstract class FSImageStorageInspector {
  ...
  /**
   * @return true if the directories are in such a state that the image should be re-saved following
   *     the load
   */
