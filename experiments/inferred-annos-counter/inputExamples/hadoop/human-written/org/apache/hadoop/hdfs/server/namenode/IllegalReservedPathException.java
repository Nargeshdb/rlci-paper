...
/**
 * Thrown when upgrading from software release that doesn't support reserved path to software
 * release that supports reserved path, and when there is reserved path name in the Fsimage.
 */
