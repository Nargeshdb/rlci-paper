...
/**
 * Namenode standby state. In this state the namenode acts as warm standby and keeps the following
 * updated:
 *
 * <ul>
 *   <li>Namespace by getting the edits.
 *   <li>Block location information by receiving block reports and blocks received from the
 *       datanodes.
 * </ul>
 *
...
public class StandbyState extends HAState {
  ...
  public void checkOperation(HAContext context, OperationCategory op) throws StandbyException {
    ...
    String msg =
        "Operation category " + op + " is not supported in state " + context.getState() + faq;
