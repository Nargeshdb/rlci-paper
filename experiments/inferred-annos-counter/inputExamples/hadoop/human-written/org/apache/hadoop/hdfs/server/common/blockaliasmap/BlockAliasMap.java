...
public abstract class BlockAliasMap<T extends BlockAlias> {
  ...
  /**
   * ImmutableIterator is an Iterator that does not support the remove operation. This could inherit
   * {@link java.util.Enumeration} but Iterator is supported by more APIs and Enumeration's javadoc
   * even suggests using Iterator instead.
   */
  ...
  /** An abstract class that is used to read {@link BlockAlias}es for provided blocks. */
  public abstract static class Reader<U extends BlockAlias> implements Iterable<U>, Closeable {
   ...
   * @return {@link Reader} to the alias map. If a Reader for the blockPoolID cannot be created,
  ...
  public abstract static class Writer<U extends BlockAlias> implements Closeable {
    /** writer options. */
    public interface Options {}
