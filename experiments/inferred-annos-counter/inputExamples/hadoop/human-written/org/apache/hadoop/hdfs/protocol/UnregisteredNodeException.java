...
/**
 * This exception is thrown when a node that has not previously registered is trying to access the
 * name node.
 */
...
public class UnregisteredNodeException extends IOException {
  ...
  /**
   * The exception is thrown if a different data-node claims the same storage id as the existing
   * one.
   *
