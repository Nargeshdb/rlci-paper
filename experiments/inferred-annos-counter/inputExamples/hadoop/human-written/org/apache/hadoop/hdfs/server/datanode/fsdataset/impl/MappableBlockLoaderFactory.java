...
public final class MappableBlockLoaderFactory {
  ...
  /**
   * Create a specific cache loader according to the configuration. If persistent memory volume is
   * not configured, return a cache loader for DRAM cache. Otherwise, return a cache loader for pmem
   * cache.
   */
