...
public interface Step {
  ...
  /**
   * Returns tolerance percentage, the good enough value when we move data from one to disk to
   * another.
   *
   * @return long.
   */
  ...
  /**
   * Returns max disk bandwidth that disk balancer will use. Expressed in MB/sec. For example, a
   * value like 10 indicates that disk balancer will only move 10 MB / sec while it is running.
   *
   * @return long.
   */
  long getBandwidth();
