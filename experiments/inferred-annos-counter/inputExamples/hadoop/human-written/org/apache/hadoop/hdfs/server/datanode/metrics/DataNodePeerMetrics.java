...
/**
 * This class maintains DataNode peer metrics (e.g. numOps, AvgTime, etc.) for various peer
 * operations.
 */
...
public class DataNodePeerMetrics {
  ...
  /**
   * Minimum number of packet send samples which are required to qualify for outlier detection. If
   * the number of samples is below this then outlier detection is skipped.
   */
  ...
  public DataNodePeerMetrics(final String name, Configuration conf) {
    ...
    this.slowNodeDetector = new OutlierDetector(MIN_OUTLIER_DETECTION_NODES, LOW_THRESHOLD_MS);
   ...
   *
   * <p>The caller should pass in a well-formatted peerAddr. e.g. "[192.168.1.110:1010]" is good.
   * This will be translated into a full qualified metric name, e.g. "[192.168.1.110:1010]AvgTime".
   */
  public void addSendPacketDownstream(final String peerAddr, final long elapsedMs) {
