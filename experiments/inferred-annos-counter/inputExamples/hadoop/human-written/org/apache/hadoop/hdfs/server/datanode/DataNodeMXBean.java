...
/**
 * This is the JMX management interface for data node information. End users shouldn't be
...
public interface DataNodeMXBean {
  ...
  /**
   * Gets the information of each volume on the Datanode. Please see the implementation for the
  ...
  /**
   * Gets the diskBalancer Status. Please see implementation for the format of the returned
   * information.
   *
  ...
  /**
   * Gets the average info (e.g. time) of SendPacketDownstream when the DataNode acts as the
   * penultimate (2nd to the last) node in pipeline.
   *
   * <p>Example Json: {"[185.164.159.81:9801]RollingAvgTime":504.867,
   * "[49.236.149.246:9801]RollingAvgTime":504.463, "[84.125.113.65:9801]RollingAvgTime":497.954}
   */
