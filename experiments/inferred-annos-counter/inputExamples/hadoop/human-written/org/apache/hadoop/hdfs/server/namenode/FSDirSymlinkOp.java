...
class FSDirSymlinkOp {
  ...
  static FileStatus createSymlinkInt(
    ...
    if (NameNode.stateChangeLog.isDebugEnabled()) {
      NameNode.stateChangeLog.debug(
          "DIR* NameSystem.createSymlink: target=" + target + " link=" + link);
    }
  ...
  static INodeSymlink unprotectedAddSymlink(
    ...
    return fsd.addINode(iip, symlink, perm.getPermission()) != null ? symlink : null;
  }
  ...
  private static INodeSymlink addSymlink(
    ...
    INodeSymlink newNode =
        unprotectedAddSymlink(fsd, parent, iip.getLastLocalName(), id, target, mtime, mtime, perm);
    if (newNode == null) {
