 ...
 *
 * <p>It allows to get the serial number of an object, if the object doesn't exist in the map, a new
 * serial number increased by 1 is generated to map to the object. The mapped object can also be got
...
public class SerialNumberMap<T> {
  ...
  public T get(int i) {
    ...
    T t = i2t.get(i);
    if (t == null) {
      throw new IllegalStateException(name + ": serial number " + i + " does not exist");
    }
    return t;
  }
