 ...
 * ReconfigurationProtocolPB}. This class translates the PB data types to the native data types used
 * inside the NN/DN as specified in the generic ReconfigurationProtocol.
 */
public class ReconfigurationProtocolServerSideTranslatorPB implements ReconfigurationProtocolPB {
  ...
  public StartReconfigurationResponseProto startReconfiguration(
      RpcController controller, StartReconfigurationRequestProto request) throws ServiceException {
    try {
