 ...
 * InterQJournalProtocol} interfaces to the RPC server implementing {@link InterQJournalProtocolPB}.
 */
...
public class InterQJournalProtocolTranslatorPB
    implements ProtocolMetaInterface, InterQJournalProtocol, Closeable {
  ...
  public GetEditLogManifestResponseProto getEditLogManifestFromJournal(
    ...
    try {
      ...
      return rpcProxy.getEditLogManifestFromJournal(NULL_CONTROLLER, req.build());
