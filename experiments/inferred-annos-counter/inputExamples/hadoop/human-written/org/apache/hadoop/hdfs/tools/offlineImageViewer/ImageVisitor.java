...
/**
 * An implementation of ImageVisitor can traverse the structure of an Hadoop fsimage and respond to
 * each of the structures within the file.
 */
abstract class ImageVisitor {

  /**
   * Structural elements of an FSImage that may be encountered within the file. ImageVisitors are
   * able to handle processing any of these elements.
   */
  ...
  /**
   * Begin visiting the fsimage structure. Opportunity to perform any initialization necessary for
   * the implementing visitor.
   */
  abstract void start() throws IOException;

  /**
   * Finish visiting the fsimage structure. Opportunity to perform any clean up necessary for the
   * implementing visitor.
   */
  abstract void finish() throws IOException;

  /**
   * Finish visiting the fsimage structure after an error has occurred during the processing.
   * Opportunity to perform any clean up necessary for the implementing visitor.
   */
  ...
  /**
   * Begin visiting an element that encloses another element, such as the beginning of the list of
   * blocks that comprise a file.
   *
   ...
   * blocks that comprise a file.
   *
   * <p>Also provide an additional key and value for the element, such as the number items within
   * the element.
   *
   * @param element Element being visited
   ...
   */
  abstract void visitEnclosingElement(ImageElement element, ImageElement key, String value)
      throws IOException;
  ...
  /**
   * Leave current enclosing element. Called, for instance, at the end of processing the blocks that
   * compromise a file.
   */
