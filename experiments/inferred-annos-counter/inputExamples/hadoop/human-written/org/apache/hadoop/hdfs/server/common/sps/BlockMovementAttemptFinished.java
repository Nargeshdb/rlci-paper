...
/**
 * This class represents status from a block movement task. This will have the information of the
 * task which was successful or failed due to errors.
 */
...
public class BlockMovementAttemptFinished {
  ...
  /**
   * @return details of the block, which attempted to move from src to target node.
   */
  ...
  public String toString() {
    return new StringBuilder()
        .append("Block movement attempt finished(\n  ")
        .append(" block : ")
        .append(block)
        .append(" src node: ")
        .append(src)
