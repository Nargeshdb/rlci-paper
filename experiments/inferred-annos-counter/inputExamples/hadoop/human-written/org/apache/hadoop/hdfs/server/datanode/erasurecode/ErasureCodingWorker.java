...
/**
 * ErasureCodingWorker handles the erasure coding reconstruction work commands. These commands would
 * be issued from Namenode as part of Datanode's heart beat response. BPOfferService delegates the
 * work to this class for handling EC commands.
 */
        ...
        new ThreadPoolExecutor(
            ...
            new ThreadPoolExecutor.CallerRunsPolicy() {
              ...
              public void rejectedExecution(Runnable runnable, ThreadPoolExecutor e) {
                LOG.info(
                    "Execution for striped reading rejected, " + "Executing in current thread");
  ...
  private void initializeStripedBlkReconstructionThreadPool(int numThreads) {
    ...
    stripedReconstructionPool =
        DFSUtilClient.getThreadPoolExecutor(
            2, numThreads, 60, new LinkedBlockingQueue<>(), "StripedBlockReconstruction-", false);
      ...
      try {
        StripedReconstructionInfo stripedReconInfo =
            new StripedReconstructionInfo(
                reconInfo.getExtendedBlock(),
                reconInfo.getErasureCodingPolicy(),
                reconInfo.getLiveBlockIndices(),
                reconInfo.getSourceDnInfos(),
                reconInfo.getTargetDnInfos(),
                reconInfo.getTargetStorageTypes(),
        ...
        LOG.warn(
            ...
            reconInfo.getExtendedBlock().getLocalBlock(),
            e);
      }
    }
  }
