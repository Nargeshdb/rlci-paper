...
/**
 * Balancing policy. Since a datanode may contain multiple block pools, {@link Pool} implies {@link
 * Node} but NOT the other way around
 */
...
abstract class BalancingPolicy {
  ...
  /**
   * @return the utilization of a particular storage type of a datanode; or return null if the
