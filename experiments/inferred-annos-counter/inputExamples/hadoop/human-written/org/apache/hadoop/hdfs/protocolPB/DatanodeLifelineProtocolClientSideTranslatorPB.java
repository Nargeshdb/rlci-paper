 ...
 * DatanodeLifelineProtocol} interfaces to the RPC server implementing {@link
 * DatanodeLifelineProtocolPB}.
 */
@InterfaceAudience.Private
public class DatanodeLifelineProtocolClientSideTranslatorPB
    implements ProtocolMetaInterface, DatanodeLifelineProtocol, Closeable {
  ...
  public DatanodeLifelineProtocolClientSideTranslatorPB(
    ...
    RPC.setProtocolEngine(conf, DatanodeLifelineProtocolPB.class, ProtobufRpcEngine2.class);
  ...
  private static DatanodeLifelineProtocolPB createNamenode(
      ...
      throws IOException {
    return RPC.getProxy(
        DatanodeLifelineProtocolPB.class,
        RPC.getProtocolVersion(DatanodeLifelineProtocolPB.class),
        nameNodeAddr,
        ugi,
        conf,
