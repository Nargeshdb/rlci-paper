...
/**
 * This holds volume reference count as AutoClosable resource. It increases the reference count by
 * one in the constructor, and decreases the reference count by one in {@link #close()}.
 *
 * <pre>{@code
