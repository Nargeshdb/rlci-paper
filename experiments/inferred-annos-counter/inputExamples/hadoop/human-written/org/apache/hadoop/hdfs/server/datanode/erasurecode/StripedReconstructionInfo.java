...
public class StripedReconstructionInfo {
  ...
  public StripedReconstructionInfo(
      ExtendedBlock blockGroup,
  ...
  private StripedReconstructionInfo(
      ExtendedBlock blockGroup,
      ErasureCodingPolicy ecPolicy,
      byte[] liveIndices,
      DatanodeInfo[] sources,
   ...
   *
   * <p>DN uses it to coordinate with NN to adjust the speed of scheduling the reconstructions tasks
   * to this DN.
   *
