...
/**
 * OfflineImageViewer to dump the contents of an Hadoop image file to XML or the console. Main entry
 * point into utility, either via the command line or programmatically.
 */
@InterfaceAudience.Private
public class OfflineImageViewer {
  public static final Logger LOG = LoggerFactory.getLogger(OfflineImageViewer.class);
  ...
  public void go() throws IOException {
    ...
    try {
      tracker =
          new PositionTrackingInputStream(
              new BufferedInputStream(Files.newInputStream(Paths.get(inputFile))));
      ...
      if (fsip == null)
        throw new IOException(
            "No image processor to read version " + imageVersionFile + " is available.");
