...
public class FinalizedProvidedReplica extends ProvidedReplica {
  ...
  public FinalizedProvidedReplica(
      long blockId,
      URI fileURI,
      long fileOffset,
      long blockLen,
  ...
  public FinalizedProvidedReplica(
      FileRegion fileRegion, FsVolumeSpi volume, Configuration conf, FileSystem remoteFS) {
    super(
        fileRegion.getBlock().getBlockId(),
        ...
        new RawPathHandle(ByteBuffer.wrap(fileRegion.getProvidedStorageLocation().getNonce())),
        volume,
        conf,
        remoteFS);
  }
