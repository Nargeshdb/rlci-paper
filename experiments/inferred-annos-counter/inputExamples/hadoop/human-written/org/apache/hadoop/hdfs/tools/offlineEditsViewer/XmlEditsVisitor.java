...
/**
 * An XmlEditsVisitor walks over an EditLog structure and writes out an equivalent XML document that
 * contains the EditLog's components.
 */
...
public class XmlEditsVisitor implements OfflineEditsVisitor {
  ...
  private static final String XML_INDENTATION_PROP =
