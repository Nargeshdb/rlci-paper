...
/**
 * Blocks movements status handler, which can be used to collect details of the completed block
 * movements.
 */
...
public interface BlocksMovementsStatusHandler {
   ...
   *
   * @param moveAttemptFinishedBlk storage movement attempt finished block
   */
