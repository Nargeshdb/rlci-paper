 ...
 *
 * <p>It analyzes file names in fsimage and prints the following information:
 *
 * <ul>
 *   <li>Number of unique file names
 *   <li>Number file names and the corresponding number range of files that use these same names
 *   <li>Heap saved if the file name objects are reused
 * </ul>
 */
...
public class NameDistributionVisitor extends TextWriterImageVisitor {
  ...
  void finish() throws IOException {
    ...
    for (long[] stat : stats) {
      ...
      totalsavings += stat[1];
      String range =
          lowbound == highbound ? " " + lowbound : " between " + lowbound + "-" + highbound;
      write(
          "\n"
              + stat[3]
              + " names are used by "
