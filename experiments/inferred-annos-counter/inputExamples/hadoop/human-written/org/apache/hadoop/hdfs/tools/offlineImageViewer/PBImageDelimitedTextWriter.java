...
/**
 * A PBImageDelimitedTextWriter generates a text representation of the PB fsimage, with each element
 ...
 *
 * <p>The default delimiter is tab, as this is an unlikely value to be included in an inode path or
...
public class PBImageDelimitedTextWriter extends PBImageTextWriter {
  ...
  static class OutputEntryBuilder {
    ...
    public String build() {
      ...
      writer.append(
          buffer, dirPermission + permissionStatus.getPermission().toString() + aclPermission);
  ...
  PBImageDelimitedTextWriter(
      PrintStream out, String delimiter, String tempPath, boolean printStoragePolicy)
      throws IOException {
