...
public class BlocksWithLocations {
  ...
  public static class BlockWithLocations {
    ...
    public BlockWithLocations(
        Block block, String[] datanodeUuids, String[] storageIDs, StorageType[] storageTypes) {
      this.block = block;
  ...
  public static class StripedBlockWithLocations extends BlockWithLocations {
    ...
    public StripedBlockWithLocations(
        BlockWithLocations blk, byte[] indices, short dataBlockNum, int cellSize) {
