...
/**
 * This class is used internally by {@link BlockManager#computeReconstructionWorkForBlocks} to
 * represent a task to reconstruct a block through replication or erasure coding. Reconstruction is
 * done by transferring data from srcNodes to targets
 */
abstract class BlockReconstructionWork {
  ...
  /**
   * An erasure coding reconstruction task has multiple source nodes. A replication task only has 1
   * source node, stored on top of the array
   */
  ...
  public BlockReconstructionWork(
      BlockInfo block,
      BlockCollection bc,
  ...
  /** Mark that the reconstruction work is to replicate internal block to a new rack. */
