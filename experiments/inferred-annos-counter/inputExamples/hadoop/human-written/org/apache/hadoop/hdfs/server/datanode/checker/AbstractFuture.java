...
/** Some portions of this class have been modified to make it functional in this package. */
 ...
 * com.google.common.base.Function) Futures.transform} and its overloaded versions.
 *
 * <p>
 *
...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
   ...
   * {@linkplain#setFuture set asynchronously}, then the cancellation will also be propagated to the
   * delegate {@code Future} that was supplied in the {@code setFuture} call.
   */
  @Override
  ...
  /**
   * Returns a value, suitable for storing in the {@link #value} field. From the given future, which
  ...
  @SuppressWarnings(
      "mustcall:return") // FP Java 8 type argument inference:
  ...
  public static @MustCall({}) <V> V getDone(Future<V> future) throws ExecutionException {
    ...
    Preconditions.checkState(
        future.isDone(), "Future was expected to be " + "done:" + " %s", future);
