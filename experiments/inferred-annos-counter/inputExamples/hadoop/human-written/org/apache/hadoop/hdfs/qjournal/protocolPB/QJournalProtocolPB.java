...
/**
 * Protocol used to journal edits to a JournalNode participating in the quorum journal. Note: This
 * extends the protocolbuffer service based interface to add annotations required for security.
 */
@KerberosInfo(
...
@ProtocolInfo(
    protocolName = "org.apache.hadoop.hdfs.qjournal.protocol.QJournalProtocol",
    protocolVersion = 1)
