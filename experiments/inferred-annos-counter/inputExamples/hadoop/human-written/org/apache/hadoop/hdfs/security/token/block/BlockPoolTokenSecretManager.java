...
/**
 * Manages a {@link BlockTokenSecretManager} per block pool. Routes the requests given a block pool
 * Id to corresponding {@link BlockTokenSecretManager}
 */
public class BlockPoolTokenSecretManager extends SecretManager<BlockTokenIdentifier> {
  ...
  /**
   * See {@link BlockTokenSecretManager#checkAccess(BlockTokenIdentifier, String, ExtendedBlock,
   * BlockTokenIdentifier.AccessMode, StorageType[], String[])}
   */
  ...
  /**
   * See {@link BlockTokenSecretManager#checkAccess(BlockTokenIdentifier, String, ExtendedBlock,
   * BlockTokenIdentifier.AccessMode, StorageType[])}
   */
  public void checkAccess(
      BlockTokenIdentifier id,
      String userId,
   ...
   */
  public void checkAccess(
      BlockTokenIdentifier id, String userId, ExtendedBlock block, AccessMode mode)
      throws InvalidToken {
    get(block.getBlockPoolId()).checkAccess(id, userId, block, mode);
  }

  /**
   * See {@link BlockTokenSecretManager#checkAccess(Token, String, ExtendedBlock,
   * BlockTokenIdentifier.AccessMode)}.
   */
  public void checkAccess(
      Token<BlockTokenIdentifier> token, String userId, ExtendedBlock block, AccessMode mode)
      throws InvalidToken {
  ...
  /**
   * See {@link BlockTokenSecretManager#generateToken(ExtendedBlock, EnumSet, StorageType[],
   * String[])}.
   */
  public Token<BlockTokenIdentifier> generateToken(
      ExtendedBlock b, EnumSet<AccessMode> of, StorageType[] storageTypes, String[] storageIds)
      throws IOException {
  ...
  public byte[] retrieveDataEncryptionKey(int keyId, String blockPoolId, byte[] nonce)
      throws IOException {
