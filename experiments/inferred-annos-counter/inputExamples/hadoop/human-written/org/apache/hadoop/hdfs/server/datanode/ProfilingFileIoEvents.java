...
/** Profiles the performance of the metadata and data related operations on datanode volumes. */
...
class ProfilingFileIoEvents {
  ...
  public void afterMetadataOp(
      @Nullable FsVolumeSpi volume, FileIoProvider.OPERATION op, long begin) {
    if (isEnabled) {
      DataNodeVolumeMetrics metrics = getVolumeMetrics(volume);
      if (metrics != null) {
  ...
  public void afterFileIo(
      @Nullable FsVolumeSpi volume, FileIoProvider.OPERATION op, long begin, long len) {
