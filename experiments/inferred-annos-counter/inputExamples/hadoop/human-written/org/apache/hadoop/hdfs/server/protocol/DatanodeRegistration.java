...
/**
 * DatanodeRegistration class contains all information the name-node needs to identify and verify a
 * data-node when it contacts the name-node. This information is sent by data-node with each
...
public class DatanodeRegistration extends DatanodeID implements NodeRegistration {
  ...
  public DatanodeRegistration(
      DatanodeID dn, StorageInfo info, ExportedBlockKeys keys, String softwareVersion) {
    super(dn);
