...
/**
 * Implementation for protobuf service that forwards requests received on {@link JournalProtocolPB}
 * to the {@link JournalProtocol} server implementation.
 */
...
public class QJournalProtocolServerSideTranslatorPB implements QJournalProtocolPB {
  ...
  private static final JournalResponseProto VOID_JOURNAL_RESPONSE =
      JournalResponseProto.newBuilder().build();

  private static final StartLogSegmentResponseProto VOID_START_LOG_SEGMENT_RESPONSE =
  ...
  @Override
  public IsFormattedResponseProto isFormatted(
      RpcController controller, IsFormattedRequestProto request) throws ServiceException {
    try {
      boolean ret =
          impl.isFormatted(
  ...
  @Override
  public GetJournalStateResponseProto getJournalState(
      RpcController controller, GetJournalStateRequestProto request) throws ServiceException {
    try {
  ...
  @Override
  public NewEpochResponseProto newEpoch(RpcController controller, NewEpochRequestProto request)
  ...
  public FormatResponseProto format(RpcController controller, FormatRequestProto request)
      throws ServiceException {
    try {
      impl.format(
          request.getJid().getIdentifier(),
   ...
   */
  @Override
  public JournalResponseProto journal(RpcController unused, JournalRequestProto req)
      throws ServiceException {
    try {
      impl.journal(
          convert(req.getReqInfo()),
          req.getSegmentTxnId(),
          req.getFirstTxnId(),
          req.getNumTxns(),
          req.getRecords().toByteArray());
    } catch (IOException e) {
   ...
   */
  @Override
  public HeartbeatResponseProto heartbeat(RpcController controller, HeartbeatRequestProto req)
      throws ServiceException {
    try {
   ...
   */
  @Override
  public StartLogSegmentResponseProto startLogSegment(
      RpcController controller, StartLogSegmentRequestProto req) throws ServiceException {
    try {
      int layoutVersion =
          req.hasLayoutVersion()
              ? req.getLayoutVersion()
  ...
  public FinalizeLogSegmentResponseProto finalizeLogSegment(
      RpcController controller, FinalizeLogSegmentRequestProto req) throws ServiceException {
    try {
  ...
  @Override
  public PurgeLogsResponseProto purgeLogs(RpcController controller, PurgeLogsRequestProto req)
      throws ServiceException {
    try {
  ...
  public GetEditLogManifestResponseProto getEditLogManifest(
      RpcController controller, GetEditLogManifestRequestProto request) throws ServiceException {
    try {
  ...
  public GetJournaledEditsResponseProto getJournaledEdits(
      RpcController controller, GetJournaledEditsRequestProto request) throws ServiceException {
    try {
      return impl.getJournaledEdits(
          request.getJid().getIdentifier(),
          request.hasNameServiceId() ? request.getNameServiceId() : null,
          request.getSinceTxId(),
          request.getMaxTxns());
  ...
  @Override
  public PrepareRecoveryResponseProto prepareRecovery(
      RpcController controller, PrepareRecoveryRequestProto request) throws ServiceException {
    try {
  ...
  @Override
  public AcceptRecoveryResponseProto acceptRecovery(
      RpcController controller, AcceptRecoveryRequestProto request) throws ServiceException {
    try {
      impl.acceptRecovery(
          convert(request.getReqInfo()), request.getStateToAccept(), new URL(request.getFromURL()));
  ...
  private RequestInfo convert(QJournalProtocolProtos.RequestInfoProto reqInfo) {
    return new RequestInfo(
        ...
        reqInfo.hasNameServiceId() ? reqInfo.getNameServiceId() : null,
        reqInfo.getEpoch(),
        reqInfo.getIpcSerialNumber(),
        reqInfo.hasCommittedTxId() ? reqInfo.getCommittedTxId() : HdfsServerConstants.INVALID_TXID);
  }

  @Override
  public DoPreUpgradeResponseProto doPreUpgrade(
      RpcController controller, DoPreUpgradeRequestProto request) throws ServiceException {
    try {
  ...
  @Override
  public DoUpgradeResponseProto doUpgrade(RpcController controller, DoUpgradeRequestProto request)
      throws ServiceException {
  ...
  @Override
  public DoFinalizeResponseProto doFinalize(
      RpcController controller, DoFinalizeRequestProto request) throws ServiceException {
    try {
      impl.doFinalize(
          convert(request.getJid()),
          request.hasNameServiceId() ? request.getNameServiceId() : null);
  ...
  @Override
  public CanRollBackResponseProto canRollBack(
      RpcController controller, CanRollBackRequestProto request) throws ServiceException {
    try {
  ...
  @Override
  public DoRollbackResponseProto doRollback(
      RpcController controller, DoRollbackRequestProto request) throws ServiceException {
    try {
  ...
  public DiscardSegmentsResponseProto discardSegments(
      RpcController controller, DiscardSegmentsRequestProto request) throws ServiceException {
    try {
      impl.discardSegments(
          convert(request.getJid()),
          request.hasNameServiceId() ? request.getNameServiceId() : null,
  ...
  @Override
  public GetJournalCTimeResponseProto getJournalCTime(
      RpcController controller, GetJournalCTimeRequestProto request) throws ServiceException {
    try {
      Long resultCTime =
          impl.getJournalCTime(convert(request.getJid()), request.getNameServiceId());
