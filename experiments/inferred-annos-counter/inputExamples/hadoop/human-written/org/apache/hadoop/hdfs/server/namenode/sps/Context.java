...
public interface Context {
   ...
   *
   * @param datanodeMap target datanodes
   ...
   *
   * @param spsPath - user invoked satisfier path
   * @throws IOException
   */
  ...
  /**
   * Handles the block move tasks. BlockMovingInfo must contain the required info to move the block,
   * that source location, destination location and storage types.
   */
  void submitMoveTask(BlockMovingInfo blkMovingInfo) throws IOException;

  /**
   * This can be used to notify to the SPS about block movement attempt finished. Then SPS will
