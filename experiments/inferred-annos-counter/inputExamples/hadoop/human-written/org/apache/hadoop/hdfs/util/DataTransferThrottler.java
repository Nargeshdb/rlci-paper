...
/**
 * a class to throttle the data transfers. This class is thread safe. It can be shared by multiple
 * threads. The parameter bandwidthPerSec specifies the total bandwidth shared by threads.
 */
public class DataTransferThrottler {
  ...
  /**
   * Given the numOfBytes sent/received since last time throttle was called, make the current thread
   * sleep if I/O rate is too fast compared to the given bandwidth.
   *
  ...
  /**
   * Given the numOfBytes sent/received since last time throttle was called, make the current thread
   * sleep if I/O rate is too fast compared to the given bandwidth. Allows for optional external
   * cancelation.
   *
   * @param numOfBytes number of bytes sent/received since last time throttle was called
