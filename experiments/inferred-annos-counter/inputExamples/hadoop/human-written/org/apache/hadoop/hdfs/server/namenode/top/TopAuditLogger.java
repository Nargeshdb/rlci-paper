...
/**
 * An {@link AuditLogger} that sends logged data directly to the metrics systems. It is used when
 * the top service is used directly by the name node
 */
...
public class TopAuditLogger implements AuditLogger {
  ...
  public void logAuditEvent(
    ...
    try {
      ...
      LOG.error(
          "An error occurred while reflecting the event in top service, "
              + "event: (cmd={},userName={})",
          cmd,
          userName);
    }
