...
public class PBImageCorruption {
  ...
  /**
   * PBImageCorruptionType is a wrapper for getting a string output for different types of
   * corruption. Could be added more cases if other types are revealed. Currently hasMissingChild
   * and isCorruptNode are the relevant cases.
   */
