...
/**
 * This class includes a replica being actively written and the reference to the fs volume where
...
public class ReplicaHandler implements Closeable {
  ...
  public ReplicaHandler(ReplicaInPipeline replica, FsVolumeReference reference) {
