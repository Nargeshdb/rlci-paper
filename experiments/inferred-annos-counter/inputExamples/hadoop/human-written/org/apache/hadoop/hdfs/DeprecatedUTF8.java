...
/**
 * A simple wrapper around {@link org.apache.hadoop.io.UTF8}. This class should be used only when it
 * is absolutely necessary to use {@link org.apache.hadoop.io.UTF8}. The only difference is that
 * using this class does not require "@SuppressWarning" annotation to avoid javac warning. Instead
 * the deprecation is implied in the class name.
 *
 * <p>This should be treated as package private class to HDFS.
 */
