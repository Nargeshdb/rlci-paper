...
public class ClientCnxnSocketNIO extends ClientCnxnSocket {
     ...
     * @throws IOException
     */
    @SuppressWarnings("builder:required.method.not.called") // FP sock.register() can throw a ClosedChannelException, in which case the sockKey is not assigned to an owning field. But, if that exception is thrown, the underlying SocketChannel must already be closed, so it's moot.
