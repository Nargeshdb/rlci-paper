...
public class UnifiedServerSocket extends ServerSocket {
    ...
    public static class UnifiedSocket extends Socket {
         ...
         */
        @Override
        @SuppressWarnings({"builder:destructor.exceptional.postcondition", "builder:contracts.postcondition"}) // FP resource aliasing: getSocketAllowUnknownMode will return sslSocket iff sslSocket is non-null (validated)
