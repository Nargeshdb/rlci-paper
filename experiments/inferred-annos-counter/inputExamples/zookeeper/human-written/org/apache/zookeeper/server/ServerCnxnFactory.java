...
public abstract class ServerCnxnFactory {
    ...
    @SuppressWarnings("builder:reset.not.owning") // FP factory is fresh when configure() is called, so nothing is reset. Also, the error message suggests that factory should be extractd into a local variable, but it already is a local variable. Bug?
