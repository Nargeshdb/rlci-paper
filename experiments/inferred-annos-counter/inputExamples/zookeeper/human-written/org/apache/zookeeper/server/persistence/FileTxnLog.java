...
public class FileTxnLog implements TxnLog, Closeable {
     ...
     * @throws IOException
     */
    @SuppressWarnings("builder:destructor.exceptional.postcondition") // TP if close() throws an exception for any element of streamsToFlush, the other elements of streamsToFlush and logStream will not be closed
